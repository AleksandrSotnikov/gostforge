...
**114 проверок** в 16 категориях · **32 автофиксера** · **30 CLI-команд** ·
...
- **32 автофиксера**: F.01–F.06 (геометрия страницы, формат и позиция
  ...
  точка после/в конце), K.02–K.04 (нумерация секций: титул без
  номера, старт основной части, сквозная нумерация), L.04.
