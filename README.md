...
**115 проверок** в 16 категориях · **34 автофиксера** · **30 CLI-команд** ·
...
- **34 автофиксера**: F.01–F.07 (геометрия страницы, формат и позиция
  номера, рамка листа ЕСКД), T.01–T.14 (шрифт, кегль, интервалы, пробелы, кавычки,
